...
public class Deposit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new ImageIcon(Deposit.class.getResource("/Icons/back-icon.png")));
        ...
        jButton1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		...
        		int a = bs.depositMoney(Integer.parseInt(jTextField1.getText()), jTextField2.getText(), Float.parseFloat(jTextField3.getText()));
        		if(a==1)
        		{
