...
import com.UI.Customer.UserMenu;
    ...
    private void initComponents() {
        ...
        jButton2.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		BankOperations v=new BankOperations();
        		BankOperations.main(null);
        		dispose();
        	}
        });
        jButton2.setIcon(new ImageIcon(Withdraw.class.getResource("/Icons/back-icon.png")));
        ...
        jButton1.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		...
        		if( found == 0 )
        		{
	        		int a = bs.withdrawMoney(Integer.parseInt(jTextField1.getText()), mode, jTextField2.getText(), Float.parseFloat(jTextField3.getText()));
	        		if(a==1)
	        		{
